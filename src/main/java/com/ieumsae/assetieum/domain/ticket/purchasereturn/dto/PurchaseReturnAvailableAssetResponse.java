...
@Getter
@Builder
public class PurchaseReturnAvailableAssetResponse {
	...
	public static PurchaseReturnAvailableAssetResponse from(TangibleAssetAssignment assignment) {
		TangibleAsset asset = assignment.getTangibleAsset();
		TangibleAssetItem item = asset.getTangibleAssetItem();

		return PurchaseReturnAvailableAssetResponse.builder()
	...
	public static PurchaseReturnAvailableAssetResponse from(IntangibleAssetAssignment assignment) {
