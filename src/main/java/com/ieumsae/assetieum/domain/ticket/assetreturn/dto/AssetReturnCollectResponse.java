...
@Getter
@Builder
public class AssetReturnCollectResponse {
	...
	public static AssetReturnCollectResponse from(Ticket ticket, AssetReturnTicket assetReturnTicket) {
		return AssetReturnCollectResponse.builder()
