...
@Getter
@Builder
public class MaintenanceAvailableAssetResponse {
	...
	public static MaintenanceAvailableAssetResponse from(TangibleAssetAssignment assignment) {
		TangibleAsset asset = assignment.getTangibleAsset();
		TangibleAssetItem item = asset.getTangibleAssetItem();

		return MaintenanceAvailableAssetResponse.builder()
